...
class CartService:
    ...
    def add_to_cart(self, cart_data: CartData, item: CartItemCreate) -> CartData:
    ...
    def update_cart_item(self, cart_data: CartData, item: CartItemUpdate) -> CartData:
    ...
    def remove_from_cart(self, cart_data: CartData, product_id: int) -> CartData:
    ...
    def get_cart_details(self, cart_data: CartData) -> CartResponse:
        if not cart_data:
        ...
        return CartResponse(
            items=cart_items, items_count=total_items, total=round(total_price)
        )
